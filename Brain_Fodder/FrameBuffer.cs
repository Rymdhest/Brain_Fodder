...
namespace Dino_Engine.Rendering
{
    public class FrameBuffer
    {
        ...
        public void resolveToScreen()
        {
            ...
            GL.BlitFramebuffer(0, 0, settings.resolution.X, settings.resolution.Y, 0, 0, Engine.Instance.outerResolution.X, Engine.Instance.outerResolution.Y, ClearBufferMask.ColorBufferBit, BlitFramebufferFilter.Linear);
            unbind();
        }
        ...
        public void unbind()
        {
            ...
            GL.Viewport(0, 0, Engine.Instance.outerResolution.X, Engine.Instance.outerResolution.Y);
        }
